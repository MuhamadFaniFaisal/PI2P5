...
<html lang="en">
  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
			  ...
			  <a class="nav-link" href="kontrak_mk.php">Kontrak_mk</a>
            </div>
          </div>
        </div>
      </nav>
      ...
      <h1><center>Daftar Kontrak_MK</center></h1> 
          ...
          if ( !empty($result)) { 
            foreach ($result as $rslt) : ?> 
              ...
              <tr> 
                ...
                <td> 
                   <a name="edit" id="edit"  class="btn btn-success" href="edit_kontrak_mk.php?id=<?= $rslt->id ?>">Edit</a> 
